...
<link rel="stylesheet" href="{{asset('public/back/css/morris.css')}}" type="text/css"/>
<!-- calendar -->
<link rel="stylesheet" href="{{asset('public/back/css/monthly.css')}}">
<!-- //calendar -->
<!-- //font-awesome icons -->
<script src="{{asset('public/back/js/jquery2.0.3.min.js')}}"></script>
<script src="{{asset('public/back/js/raphael-min.js')}}"></script>
<script src="{{asset('public/back/js/morris.js')}}"></script>
</head>
<body>
