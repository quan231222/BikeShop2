                ...
                @foreach ($all_product as $key => $product)
                    <div class="col-md-3" style="border: 1px solid #ddd; border-radius:10px; margin: 33px">
                        ...
                        <div class="grid-chain-bottom" style="font-size: 12px">
                            <li style="display: inline;" type="none"><a href=""><i class="fa fa-plus-square"></i> Yêu
                                    thích</a></li>
                            <li style="display: inline; float: right" type="none"><a href=""><i
                                        class="fa fa-plus-square"></i> So
                                    sánh</a></li>
                        </div>
                    </div>
                @endforeach
