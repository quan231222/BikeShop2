                        ...
                        <form action="{{ URL::to('/save-product') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div style="margin: 0 auto; width: 60%">
                                    <div class="form-group">
                                        ...
                                        <textarea name="product_desc" class="form-control textarea"
                                            placeholder="Mô tả sản phẩm" id="ckeditor1"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div style="margin: 0 auto; width: 60%">
                                    <div class="form-group">
                                        ...
                                        <textarea name="product_content" class="form-control textarea"
                                            placeholder="Nội dung sản phẩm" id="ckeditor2"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="update ml-auto mr-auto">
                                    <button type="submit" name="add_product" class="btn btn-primary btn-round">Thêm sản
                                        phẩm</button>
                                </div>
                            </div>
                        </form>
