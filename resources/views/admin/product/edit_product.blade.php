...
@section('content')
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="{{ URL::to('/show-product') }}" class="btn btn-primary btn-round" style="margin-bottom: 10px">Quay
                    lại</a>
                            ...
                            <form action="{{ URL::to('/update-product/ ' . $pro->product_id) }}" method="post"
                                    ...
                                    <div style="margin: 0 auto; width: 60%">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="product_name" class="form-control"
                                                value="{{ $pro->product_name }}" placeholder="Tên sản phẩm">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div style="margin: 0 auto; width: 60%">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="product_color" class="form-control"
                                                value="{{ $pro->product_color }}" placeholder="Màu sản phẩm">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div style="margin: 0 auto; width: 60%">
                                        <div class="form-group">
                                            ...
                                            <textarea name="product_desc" class="form-control textarea"
                                                ...
                                                id="ckeditor1">{{ $pro->product_desc }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div style="margin: 0 auto; width: 60%">
                                        <div class="form-group">
                                            ...
                                            <textarea name="product_content" class="form-control textarea"
                                                placeholder="Nội dung sản phẩm"
                                                id="ckeditor2">{{ $pro->product_content }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="update ml-auto mr-auto">
                                        <button type="submit" name="add_product" class="btn btn-primary btn-round">Cập nhật
                                            sản phẩm</button>
                                    </div>
                                </div>
                            </form>
