...
@section('content')
    <div class="container-fluid">
                            ...
                            <div class="col-sm-12">
                                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0"
                                    ...
                                    <thead style="text-align: center">
                                        <tr role="row">
                                            <th class="sorting sorting_asc" tabindex="0" aria-controls="dataTable"
                                                ...
                                                Tên danh mục bài viết</th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" aria-label="Position: activate to sort column ascending">Mô tả
                                                danh mục sản phẩm</th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" aria-label="Position: activate to sort column ascending"
                                                style="width: 200px;">Hiển
                                                thị</th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                    ...
                                    <tfoot style="text-align: center">
                                        <tr>
                                            <th rowspan="1" colspan="1">Tên danh mục bài viết</th>
                                            <th rowspan="1" colspan="1">Mô tả danh mục</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span>
                                                        ...
                                                        ?>
                                                        <a style="color:red;"
                                                            href="{{ URL::to('/active-cate-post/' . $cate_post->cate_post_id) }}">
                                                        ...
                                                        <a style="color:#32CD32"
                                                            href="{{ URL::to('/unactive-cate-post/' . $cate_post->cate_post_id) }}">
                                                            <span class="fas fa-circle"></span>
                                                        </a>
                                                        <?php
                                                        }
        ...
        {{-- <div class="col-sm-5"
                                ...
                                <form action="{{ URL('import-excel-cate_post') }}" method="post"
        ...
        {{-- <div class="col-sm-5"
                                style="border: 1px solid #e3e6f0; padding: 10px; text-align: center">
                                <form action="{{ URL('export-excel-cate_post') }}" method="post">
                                    @csrf
